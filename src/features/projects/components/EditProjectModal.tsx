...
function makeStyles(C: ThemeColors) {
    return StyleSheet.create({
        ...
        content: { backgroundColor: C.background, borderTopLeftRadius: RADIUS.xl, borderTopRightRadius: RADIUS.xl, paddingTop: SPACING.xl, paddingHorizontal: SPACING.lg, maxHeight: '90%' },
        header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: SPACING.lg },
        title: { color: C.white, fontSize: FONTS.sizes.xl, fontWeight: 'bold' },
        closeBtn: { padding: 4 },
        scrollArea: { marginBottom: 20 },
        label: { color: C.textSecondary, fontSize: 13, fontWeight: 'bold', marginBottom: 8, marginTop: SPACING.md },
        input: { backgroundColor: C.surface, color: C.white, paddingHorizontal: SPACING.md, height: 50, borderRadius: RADIUS.md, borderWidth: 1, borderColor: C.border },

        typeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
        typeCard: { width: '48%', backgroundColor: C.surface, borderRadius: RADIUS.md, padding: SPACING.sm, alignItems: 'center', borderWidth: 1, borderColor: C.border },
        typeCardActive: { borderColor: C.primary, backgroundColor: C.primary + '20' },
        typeIcon: { fontSize: 24, marginBottom: 4 },
        typeLabel: { color: C.textMuted, fontSize: 11, textAlign: 'center', fontWeight: '500' },
        typeLabelActive: { color: C.white, fontWeight: 'bold' },

        saveBtn: { backgroundColor: C.primary, height: 56, borderRadius: RADIUS.md, alignItems: 'center', justifyContent: 'center', marginTop: SPACING.xl, ...SHADOWS.md },
        saveText: { color: C.white, fontWeight: 'bold', fontSize: 16 }
    });
}
