...
import { FONTS, RADIUS, SHADOWS, SPACING } from '../../../core/theme';
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.navbar}>
                    <View style={styles.navLogo}>
                        <Image source={require('../../../../assets/logo-symbol-transparent.png')} style={{ width: 40, height: 40, resizeMode: 'contain', marginRight: 8 }} />
                        <Text style={styles.navLogoText}>OBRA<Text style={{ color: C.primary }}>TRACK</Text></Text>
                    </View>
                    ...
                    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                        <View style={styles.loginCard}>
                            ...
                            <TouchableOpacity style={styles.loginBtn} onPress={handleLogin}>
                                ...
                                <Icon name="arrow-right" size={20} color={C.white} />
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity style={{ alignItems: 'center', marginTop: SPACING.lg }} onPress={() => navigation.navigate('PrivacyPolicy')}>
                                <Text style={{ color: C.textMuted, fontSize: 12 }}>Política de Privacidad</Text>
                            </TouchableOpacity>
                        </View>
                ...
                <View style={styles.plansBanner}>
                    ...
                    <View style={styles.plansRow}>
                        ...
                        <View style={[styles.planCard, styles.planCardPro]}>
                            ...
                            <Text style={[styles.planName, { color: C.white }]}>Premium</Text>
                            <Text style={[styles.planPrice, { color: C.primary }]}>$44.900 <Text style={styles.planPer}>COP/mes</Text></Text>
                            <View style={styles.planFeatures}>
                                {['5 usuarios por rol', '5 proyectos activos', 'Reportes PDF con firma', 'Logística de envíos', 'Exportación Excel y CSV', 'Usuarios extra (add-on)'].map(f =>
                                    <Text key={f} style={[styles.planFeature, { color: C.white }]}>✓ {f}</Text>
                                )}
                            </View>
                    ...
                    <View style={styles.footerTop}>
                        ...
                        <View style={styles.footerBrandCol}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: SPACING.sm }}>
                                <Image source={require('../../../../assets/logo-symbol-transparent.png')} style={{ width: 32, height: 32, resizeMode: 'contain', marginRight: 8 }} />
                                <Text style={styles.footerBrand}>OBRA<Text style={{ color: C.primary }}>TRACK</Text></Text>
                            </View>
...
function makeStyles(C: ThemeColors) {
    return StyleSheet.create({
        ...
        navLogoText: { fontSize: 26, fontWeight: '900', color: C.white, letterSpacing: 2 },
        navLinks: { flexDirection: 'row', alignItems: 'center' },
        navLink: { color: C.textPrimary, fontSize: 15, fontWeight: '600', marginLeft: 36 },
        navRegisterBtn: {
            marginLeft: 36, borderWidth: 2, borderColor: C.primary,
            paddingVertical: 9, paddingHorizontal: 22, borderRadius: 50,
        },
        navRegisterText: { color: C.primary, fontWeight: 'bold', fontSize: 15 },
        ...
        heroTitle: { fontSize: 52, fontWeight: '900', color: C.white, lineHeight: 62, marginBottom: SPACING.xl },
        heroDescription: { fontSize: 17, color: C.textSecondary, lineHeight: 27, marginBottom: SPACING.xxl },
        featureList: { marginTop: SPACING.md },
        featureItem: { flexDirection: 'row', alignItems: 'center', marginBottom: SPACING.md },
        featureText: { color: C.white, fontSize: 16, fontWeight: '600', marginLeft: SPACING.md },
        ...
        loginTitle: { fontSize: 26, fontWeight: 'bold', color: C.white, marginBottom: 4 },
        loginSubtitle: { fontSize: 14, color: C.textMuted, marginBottom: SPACING.xl },
        inputGroup: {
        ...
        input: {
            flex: 1, color: C.white, fontSize: 15, height: '100%',
        ...
        loginBtnText: { color: C.white, fontSize: 17, fontWeight: 'bold' },
        divider: { flexDirection: 'row', alignItems: 'center', marginVertical: SPACING.lg },
        line: { flex: 1, height: 1, backgroundColor: C.border },
        orText: { color: C.textMuted, paddingHorizontal: SPACING.md, fontSize: 13 },
        createAccountBtn: {
            height: 56, borderRadius: RADIUS.md, alignItems: 'center', justifyContent: 'center',
            borderWidth: 1, borderColor: C.border, backgroundColor: 'rgba(46, 64, 96, 0.2)',
        },
        createAccountText: { color: C.white, fontSize: 15, fontWeight: '600' },

        // ── Plans ────────────────────────────────────────────────────────────────────
        plansBanner: {
            paddingHorizontal: '8%', paddingVertical: 60, backgroundColor: 'rgba(10, 18, 28, 0.85)', zIndex: 10,
        },
        plansBannerTitle: { fontSize: 34, fontWeight: '900', color: C.white, textAlign: 'center', marginBottom: 36 },
        plansRow: { flexDirection: 'row', justifyContent: 'center', gap: 24, flexWrap: 'wrap' },
        planCard: {
            width: 320, backgroundColor: C.surface, borderRadius: RADIUS.lg,
            padding: 32, borderWidth: 1, borderColor: C.border,
        },
        planCardPro: {
            backgroundColor: C.primary + '18', borderColor: C.primary, position: 'relative',
        },
        planCardEnterprise: {
        ...
        proTag: {
            ...
            backgroundColor: C.primary, paddingHorizontal: 14, paddingVertical: 4, borderRadius: 20,
        },
        proTagText: { color: C.white, fontSize: 11, fontWeight: '900', letterSpacing: 1 },
        planName: { color: C.textSecondary, fontSize: 16, fontWeight: '700', marginBottom: 8 },
        planPrice: { color: C.white, fontSize: 32, fontWeight: '900', marginBottom: 20 },
        planPer: { fontSize: 14, fontWeight: '400', color: C.textMuted },
        planFeatures: { marginBottom: 28, gap: 10 },
        planFeature: { color: C.textSecondary, fontSize: 14 },
        planBtnOutline: {
            height: 48, borderRadius: RADIUS.md, borderWidth: 1, borderColor: C.primary,
            alignItems: 'center', justifyContent: 'center',
        },
        planBtnOutlineText: { color: C.primary, fontWeight: 'bold', fontSize: 15 },
        planBtnSolid: {
            height: 48, borderRadius: RADIUS.md, backgroundColor: C.primary,
            alignItems: 'center', justifyContent: 'center',
        },
        planBtnSolidText: { color: C.white, fontWeight: 'bold', fontSize: 15 },
        ...
        footerBrand: { fontSize: 22, fontWeight: '900', color: C.white, letterSpacing: 2 },
        footerTagline: { color: C.textMuted, fontSize: 13, lineHeight: 22, maxWidth: 320 },
        footerLinksCol: { flex: 1, minWidth: 140 },
        footerColTitle: { color: C.white, fontWeight: '700', fontSize: 14, marginBottom: 16 },
        footerLink: { color: C.textMuted, fontSize: 13, marginBottom: 12 },

        footerBottom: {
            paddingHorizontal: '8%', paddingVertical: 20, alignItems: 'center',
        },
        footerDisclaimer: {
            color: C.textMuted, fontSize: 12, textAlign: 'center', lineHeight: 20, maxWidth: 700,
        },
    });
}
