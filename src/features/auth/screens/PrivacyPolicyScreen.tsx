    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                >
                    <Icon name="mail" size={18} color={C.white} />
...
function makeStyles(C: ThemeColors) {
    return StyleSheet.create({
        ...
        intro: {
            ...
            marginBottom: SPACING.lg, borderLeftWidth: 3, borderLeftColor: C.primary
        },
        introDate: { color: C.primary, fontSize: FONTS.sizes.sm, fontWeight: 'bold', marginBottom: 4 },
        introText: { color: C.textSecondary, fontSize: FONTS.sizes.sm, lineHeight: 22 },

        section: {
            backgroundColor: C.surface, borderRadius: RADIUS.md, padding: SPACING.md,
            marginBottom: SPACING.md,
        },
        sectionTitle: { color: C.white, fontSize: FONTS.sizes.md, fontWeight: 'bold', marginBottom: SPACING.sm },
        sectionText: { color: C.textSecondary, fontSize: FONTS.sizes.sm, lineHeight: 22 },

        emailBtn: {
            flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
            backgroundColor: C.primary, padding: SPACING.md, borderRadius: RADIUS.md, gap: 8, marginTop: SPACING.md
        },
        emailBtnText: { color: C.white, fontWeight: 'bold', fontSize: FONTS.sizes.md },
    });
}
